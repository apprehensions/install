...
ROOT="/dev/nvme0n1p1"
BOOT="/dev/nvme0n1p2"
BOOT_UUID=$(blkid -s UUID -o value $ROOT)
ROOT_UUID=$(blkid -s UUID -o value $BOOT)
...
chroot /mnt ln -s /etc/sv/acpid /mnt/var/service/
chroot /mnt ln -s /etc/sv/iwd /mnt/var/service/
